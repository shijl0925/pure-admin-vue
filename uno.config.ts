...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'bg-login-wave-1': 'animate-move-forever animate-delay-[-2s] animate-duration-[7s]',
    'bg-login-wave-2': 'animate-move-forever animate-delay-[-3s] animate-duration-[10s]',
    'bg-login-wave-3': 'animate-move-forever animate-delay-[-4s] animate-duration-[13s]',
    'bg-login-wave-4': 'animate-move-forever animate-delay-[-5s] animate-duration-[20s]',
  },
  theme: {
    animation: {
      keyframes: {
